...
//	ft_printf("--------------------%%s--------------------\n");
	printf("01) standart PRINTF : |%*i|\n", -14, 94827);
	ft_printf("01) my       PRINTF : |%*i|\n", -14, 94827);
...
//	 printf("17) standart PRINTF : |%-10.8p|\n", NULL);
//	 ft_printf("17) my       PRINTF : |%-10.8p|\n", NULL);
...
//	free(tab2);
//	ft_printf("----------------%%d-%%i--------------------\n");
//	printf("01) standart PRINTF : |%-8.5d|\n", 42);
//	ft_printf("01) my       PRINTF : |%-8.5d|\n", 42);
...
//	printf("31) standart PRINTF : |%5.0d|\n", 0);
//	ft_printf("31) my       PRINTF : |%5.0d|\n", 0);
//	printf("32) standart PRINTF : |%05d|\n", 54);
//	ft_printf("32) my       PRINTF : |%05d|\n", 54);
//	ft_printf("--------------------%%x--------------------\n");
...
//	 ft_printf("%%%");
//	 ft_printf("|\n\n");
//	ft_printf("return for my PRINTF : %d\nreturn for my PRINTF : %d\n\n",
//		   printf("%%"), printf("%%"));
//	printf("return for st PRINTF : %d\nreturn for my PRINTF : %d\n\n",
//		ft_printf("%%"), ft_printf("%%"));

//	ft_printf("return for st PRINTF : %d\nreturn for my PRINTF : %d\n\n", printf("%5%"), ft_printf("%5%"));
//	ft_printf("return for st PRINTF : %d\nreturn for my PRINTF : %d\n\n", printf("%.*s|\n", 5, "kekwait"), ft_printf("%.*s|\n", 5, "kekwait"));
//	printf("%d\n", printf("%d, ", printf("kekw%s, ", "asfa")));
//	ft_printf("%d\n", ft_printf("%d, ", ft_printf("kekw%s, ", "safa")));
//	ft_printf("--------------------%%kek------------------\n");
...
//	printf("______________________________________\n");
//	printf("%-5c|(-5c)  ~ORIG~\n", c);
//	ft_printf("%-5c|(-5c)  ~CHINA~\n", c);
//	printf("______________________________________\n");
//	printf("%5c|(5c)   ~ORIG~\n", c);
//	ft_printf("%5c|(5c)   ~CHINA~\n", c);
//	printf("______________________________________\n");
//	printf("%-05c|(-05c) ~ORIG~\n", c);
//	ft_printf("%-05c|(-05c) ~CHINA~\n", c);
//	printf("______________________________________\n");
//	printf("%05c|(05c)  ~ORIG~\n", c);
//	ft_printf("%05c|(05c)  ~CHINA~\n", c);
//	printf("______________________________________\n");
...
//
//	printf("______________________________________\n");
//	printf("%15.5s|(15.5s) ORIG\n", string);
//	ft_printf("%15.5s|(15.5s) CHINA\n", string);
//	printf("______________________________________\n");
//	printf("%s|(strNull) ORIG\n", strNull);
//	ft_printf("%s|(strNull) CHINA\n", strNull);
//	printf("______________________________________\n");
//	printf("%10s|(s)ORIG\n", string);
//	ft_printf("%10s|(s)CHINA\n", string);
//	printf("______________________________________\n");
//	printf("%-15.20s|(-15s) ORIG\n", string);
//	ft_printf("%-15.20s|(-15s) CHINA\n", string);
//	printf("______________________________________\n");
//	printf("%015s|(015s) ORIG\n", string);
//	ft_printf("%015s|(015s) CHINA\n", string);
//	printf("______________________________________\n");
//
//*/
//
